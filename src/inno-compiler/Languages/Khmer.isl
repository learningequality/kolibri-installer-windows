...
InstallPythonMsg=អ្នកត្រូវការកម្មវិធី Python 3.9+ ដែលបានដំឡើងតាមលំដាប់លំដោយដើម្បីដំណើរការ Kolibri។ Setup Wizard មិនត្រូវបានរកឃើញ Python ទេនៅក្នុងប្រព័ន្ធ និងបន្តដំឡើងវាឥឡូវនេះ។ សូមចុចពាក្យ "បាទ/ចាស" ដើម្បីទទួលយក និងបន្តការដំឡើងនេះ។ 
