...
InstallPythonMsg=شما برای راه‌اندازی کُلیبری باید پایتون 3.9+ را نصب کرده باشید. بخش راه‌اندازی قادر به یافتن پایتون بر روی سیستم شما نبود و اکنون اقدام به نصب آن خواهد کرد. لطفن بر روی گزینه‌ی «بلی» کلیک کنید تا نصب آن را تایید و ادامه دهید. 
