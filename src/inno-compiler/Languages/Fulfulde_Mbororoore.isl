...
LanguageName=Fulfulde Mbororoore 
LanguageID=0 
LanguageCodePage=0 
...
InstallPythonMsg=You need to have Python 3.8+ installed in order to run Kolibri. Setup Wizard was not able to find Python on your system and will now proceed to install it. Please click 'Yes' to confirm and continue with the installation.
