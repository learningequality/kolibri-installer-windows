...
InstallPythonMsg=Es necesario tener Python 3.8+ instalado para poder ejecutar Kolibri. Asistente de instalación no pudo encontrar Python en su sistema y ahora procederá a instalarlo. Haga clic en 'Sí' para confirmar y continuar con la instalación. 
