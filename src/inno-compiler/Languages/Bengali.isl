...
InstallPythonMsg=কলিব্রি ব্যবহার করার জন্য আপনার Python 3.9+ ইন্সটল থাকা প্রয়োজন। সেটআপ উইজার্ড আপনার সিস্টেমে Python খুঁজে পায়নি এবং সেটা এখন ইন্সটল করতে চলেছে। অনুগ্রহ করে 'হ্যাঁ' ক্লিক করুন এবং ইন্সটলেশন চালিয়ে যান। 
