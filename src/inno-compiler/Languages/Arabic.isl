...
InstallPythonMsg=تحتاج إلى تثبيت لغة برمجة Python 3.9+ من أجل تشغيل كوليبري. لم يتمكن معالج الإعداد من العثور على Python على النظام الخاص بك وسوف ييقوم الآن بتثبيته. الرجاء النقر فوق 'نعم' للتأكيد ومواصلة التثبيت. 
