...
ConfirmUninstall=Are you sure that you would like to remove Kolibri from your computer?
...
UninstallKolibriData=Would you also like to delete all data associated with Kolibri? This will permanently remove downloaded content and user data, after which they cannot be recovered.
