...
MissingWOW64APIs=A vers�o do Windows que est� a utilizar n�o disp�e das funcionalidades necess�rias para o Assistente de Instala��o poder realizar uma instala��o de 64-bit's. Para corrigir este problema, por favor instale o Service Pack %1.
...
PipNotFound= is unavailable. If the location is on this PC, make sure the python folder is in right path and try again. If the location still cannot be found, it might been moved or deleted.
Needhelp=%n%nNeed help?%nSend through email the Kolibri-setup log to our technical support at learningequality.org %n%nFile: