...
PipNotFound= no está disponible. Si la ubicación está en esta PC, asegúrese de que la carpeta python esté en la ruta correcta e intente nuevamente. Si aún no se puede encontrar la ubicación, se podría haber movido o eliminado.
Needhelp=%n%nNecesitas ayuda?%nEnvíe por correo electrónico el registro de configuración de Kolibri a nuestro soporte técnico en learningequality.org %n%nFile:
