...
InstallPtythonErrMsg=Error' #13 #13 'Se necesita Python 2.7.13+ para continuar! Instalación terminará. 
...
PipErrMsg=Fatal error' #13 #13' Instale pip y vuelva a intentarlo. 
SetupInstallKolibriMsg=Instalación instalará ahora Kolibri fuente archivos en tu sitio-paquete de Python. 
SetupKolibriErrMsg=Error crítico.' #13 #13 ' dependencias no han podido instalar. Número de error: 
